...
<head>
    ...
    <title>Sign in to Unity Calendar</title>
    ...
    <div class="login-container">
        <div class="login-visual">
            <div class="visual-content">
                ...
                <p class="visual-subtitle">Continue your productivity journey with Unity Calendar's powerful team coordination tools.</p>
        ...
        <div class="login-form">
            <div class="form-header">
                ...
                <p class="form-subtitle">Access your Unity Calendar account</p>
            </div>
